-- definitions.sql - configuration file for PerfSheet4
-- 
...
--this defines the amount of days under analysis (AWR queries will have this as where condition)
-- CUSTOMIZE HERE: change for the preferred interval length
define delta_time_where_clause="between sysdate-7 and sysdate"
define first_delta_snap_where_clause="between 35064 and 35348"
define second_delta_snap_where_clause="between 37268 and 37552" 
